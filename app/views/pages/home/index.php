<div class="container py-4 my-4 min-vh-100">
    ...
    <div class="container mt-5 ">
        <h3 class="font-weight-bold text-center">South Korea COVID-19 Cases</h3>
        <div class="row">
            <div class="col-sm ">
    ...
    <div class="container mt-5 card shadow p-2">
        <h3 class="mt-4 font-weight-bold text-center">South Korea COVID-19 Cases</h3>
        ...
        <table class="table-bordered text-center">
            <tr>
                <th class="table-active" rowspan="2">No</th>
                <th class="table-active" rowspan="2">Provinsi</th>
